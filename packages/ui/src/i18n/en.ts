export const dict: Record<string, string> = {
  ...
  "ui.prompt.empty": "No matching items",
  "ui.prompt.commands": "Commands",
  "ui.prompt.dropFiles": "Drop files to attach",
  "ui.prompt.removeAttachment": "Remove attachment",
  "ui.prompt.label": "Prompt",
  "ui.prompt.placeholder.shell": "Enter shell command...",
  "ui.prompt.placeholder.normal": "Ask anything, / for commands, @ for context...",
  "ui.prompt.addFiles": "Add images and files",
  "ui.prompt.files": "Images and files",
  "ui.prompt.context": "Context",
  "ui.prompt.shell": "Shell command",
  "ui.prompt.chooseAgent": "Choose agent",
  "ui.prompt.chooseModel": "Choose model",
  "ui.prompt.chooseVariant": "Choose model variant",
  "ui.prompt.send": "Send",
  "ui.prompt.stop": "Stop",
