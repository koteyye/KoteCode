...
export function WindowsAppMenu(props: {
  ...
  const label = (value: string) => desktopMenuLabel(value, language.locale())
    ...
    <DropdownMenu gutter={4} modal={false} placement="bottom-start">
      {props.variant === "v2" ? (
        ...
        >
          <DropdownMenu.Trigger
            ...
            aria-label={language.t("desktop.menu.aria")}
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content class="desktop-app-menu">
          <DropdownMenu.Group>
            <DropdownMenu.GroupLabel class="desktop-app-menu-heading">KoteCode</DropdownMenu.GroupLabel>
