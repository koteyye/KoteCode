export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models from OpenCode Zen",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in KoteCode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in KoteCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in KoteCode.",
  "provider.connect.oauth.auto.confirmationCode": "Confirmation code",
  "provider.connect.toast.connected.title": "{{provider}} connected",
  "provider.connect.toast.connected.description": "{{provider}} models are now available to use.",
  "provider.routing.title": "Connection route",
  "provider.routing.label": "Use Kote Gateway",
  "provider.routing.description": "Choose how KoteCode sends requests to this provider.",
  "provider.routing.proxy.short": "Kote Gateway",
  "provider.routing.proxy.description": "A network gateway for stable connectivity to API providers.",
  "provider.routing.direct.short": "Direct",
  "provider.routing.direct.description": "Connect directly to the API provider.",
  ...
  "dialog.plugins.empty": "Plugins configured in kotencode.json",
  ...
  "dialog.server.description": "Switch which KoteCode server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking KoteCode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking KoteCode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating KoteCode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating KoteCode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update KoteCode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update KoteCode",
  "wsl.onboarding.opencodeReadyIn": "KoteCode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "KoteCode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install KoteCode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install KoteCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "KoteCode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before KoteCode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "KoteCode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen KoteCode.",
  ...
  "toast.update.description": "A new version of KoteCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the KoteCode team",
  ...
  "error.chain.checkConfig": "Check your config (kotencode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, KoteCode does not support MCP authentication yet.',
  ...
  "common.unexpectedServerError": "Unexpected server error. Check server logs for details.",
  ...
  "command.project.openIndex": "Open project {{number}}",
  "titlebar.update": "Update",
  "titlebar.update.version": "Update {{version}}",
  "debug.tools.toggle": "Toggle debug tools",
  "debug.focus.force": "Force focus styles on all interactive elements",
  "debug.focus.label": "Focus",
  "debug.focus.on": "On",
  "debug.focus.off": "Off",
  "desktop.menu.aria": "KoteCode menu",

  "help.tabs.toast.aria": "Introducing Tabs. Organize your work and active sessions with tabs",
  ...
  "help.tabs.body.intro": "KoteCode Desktop is now built around tabs.",
  ...
  "help.tabs.body.persist": "When you reopen the app, your tabs are still open.",
  "help.tabs.body.worktrees":
    "The new design does not support Git Worktrees yet; support is coming soon. You can switch back to the previous layout in Settings for a limited time.",
  ...
  "sidebar.gettingStarted.line1": "KoteCode includes free models so you can start immediately.",
  ...
  "settings.gateway.section.active": "Active gateway",
  "settings.gateway.kote.name": "Kote Gateway",
  "settings.gateway.kote.description": "Use the gateway included with KoteCode.",
  "settings.gateway.action.add": "Add proxy",
  "settings.gateway.dialog.addTitle": "Add proxy",
  "settings.gateway.dialog.editTitle": "Edit proxy",
  "settings.gateway.dialog.name": "Name",
  "settings.gateway.dialog.namePlaceholder": "Work proxy",
  "settings.gateway.dialog.url": "Proxy URL",
  "settings.gateway.dialog.urlPlaceholder": "https://proxy.example.com:8443",
  "settings.gateway.dialog.error.name": "Enter a name for this proxy.",
  "settings.gateway.dialog.error.duplicate": "A proxy with this name already exists.",
  "settings.gateway.dialog.error.url": "Enter an HTTP or HTTPS proxy origin without a path, query, or fragment.",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Run the KoteCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for KoteCode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how KoteCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether KoteCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how KoteCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when KoteCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of KoteCode.",
