export const dict = {
  ...
  "provider.routing.label": "Use Kote Proxy",
  "provider.routing.description": "Choose how KoteCode sends requests to this provider.",
  "provider.routing.proxy.short": "Kote Proxy",
  "provider.routing.proxy.description": "Send requests through Kote Proxy.",
  "provider.routing.direct.short": "Direct",
  "provider.routing.direct.description": "Connect to the provider without Kote Proxy.",
