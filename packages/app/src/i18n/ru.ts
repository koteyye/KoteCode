export const dict = {
  ...
  "provider.routing.label": "Использовать Kote Proxy",
  "provider.routing.description": "Выберите, как KoteCode будет отправлять запросы этому провайдеру.",
  "provider.routing.proxy.short": "Kote Proxy",
  "provider.routing.proxy.description": "Отправлять запросы через Kote Proxy.",
  "provider.routing.direct.short": "Напрямую",
  "provider.routing.direct.description": "Подключаться к провайдеру без Kote Proxy.",
