export const dict = {
  ...
  "dialog.provider.custom.label": "Свой провайдер, совместимый с OpenAI",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели OpenCode Zen",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API-ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в KoteCode.",
  ...
  "provider.connect.opencodeZen.line1":
    "OpenCode Zen даёт доступ к отобранным надёжным моделям, оптимизированным для программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в KoteCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в KoteCode.",
  ...
  "provider.routing.title": "Маршрут подключения",
  "provider.routing.label": "Использовать Kote Gateway",
  "provider.routing.description": "Выберите, как KoteCode будет отправлять запросы этому провайдеру.",
  "provider.routing.proxy.short": "Kote Gateway",
  "provider.routing.proxy.description": "Сетевой шлюз для стабильного подключения к API-провайдерам.",
  "provider.routing.direct.short": "Напрямую",
  "provider.routing.direct.description": "Подключаться к API-провайдеру напрямую.",
  ...
  "dialog.server.description": "Выберите сервер KoteCode, к которому подключается приложение.",
  ...
  "wsl.onboarding.step.opencode": "KoteCode",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка KoteCode...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка KoteCode в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление KoteCode...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление KoteCode в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите KoteCode в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить KoteCode",
  "wsl.onboarding.opencodeReadyIn": "KoteCode в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "KoteCode готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите KoteCode в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить KoteCode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "KoteCode не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в KoteCode требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "KoteCode не удалось проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте KoteCode.",
  ...
  "toast.update.description": "Новая версия KoteCode ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Сообщите об этой ошибке команде KoteCode",
  ...
  "common.unexpectedServerError": "Непредвиденная ошибка сервера. Подробности доступны в журналах.",
  ...
  "command.project.openIndex": "Открыть проект {{number}}",
  "titlebar.update": "Обновить",
  "titlebar.update.version": "Обновить до {{version}}",
  "debug.tools.toggle": "Показать или скрыть инструменты отладки",
  "debug.focus.force": "Принудительно показать стили фокуса для всех интерактивных элементов",
  "debug.focus.label": "Фокус",
  "debug.focus.on": "Вкл.",
  "debug.focus.off": "Выкл.",
  "desktop.menu.aria": "Меню KoteCode",

  "help.tabs.toast.aria": "Новые вкладки. Организуйте работу и активные сессии с помощью вкладок",
  "help.tabs.toast.dismiss": "Закрыть информацию о вкладках",
  "help.tabs.title": "Знакомьтесь: вкладки",
  "help.tabs.description": "Организуйте работу и активные сессии с помощью вкладок",
  "help.tabs.date": "14 июля",
  "help.tabs.body.intro": "KoteCode Desktop теперь использует вкладки.",
  "help.tabs.body.start":
    "Создавайте новые сессии во вкладках или открывайте существующие сессии из любого проекта. Открывайте вкладку для новой задачи и закрывайте её после завершения.",
  "help.tabs.body.organize":
    "Несколько открытых вкладок помогают организовать активные сессии. Если вкладка нужна надолго, дайте ей понятное имя.",
  "help.tabs.body.home":
    "Все сессии и проекты находятся на новом главном экране. Выбранная сессия откроется во вкладке.",
  "help.tabs.body.persist": "После перезапуска приложения открытые вкладки сохраняются.",
  "help.tabs.body.worktrees":
    "Новый интерфейс пока не поддерживает рабочие деревья Git. Поддержка появится позже, а до тех пор в настройках можно временно вернуться к прежнему интерфейсу.",
  "common.key.esc": "ESC",
  ...
  "sidebar.gettingStarted.line1": "KoteCode включает бесплатные модели, поэтому можно начать сразу.",
  ...
  "app.name.desktop": "KoteCode Desktop",
  ...
  "settings.gateway.section.active": "Активный шлюз",
  "settings.gateway.kote.name": "Kote Gateway",
  "settings.gateway.kote.description": "Использовать шлюз, встроенный в KoteCode.",
  "settings.gateway.action.add": "Добавить прокси",
  "settings.gateway.dialog.addTitle": "Добавить прокси",
  "settings.gateway.dialog.editTitle": "Изменить прокси",
  "settings.gateway.dialog.name": "Название",
  "settings.gateway.dialog.namePlaceholder": "Рабочий прокси",
  "settings.gateway.dialog.url": "URL прокси",
  "settings.gateway.dialog.urlPlaceholder": "https://proxy.example.com:8443",
  "settings.gateway.dialog.error.name": "Укажите название прокси.",
  "settings.gateway.dialog.error.duplicate": "Прокси с таким названием уже существует.",
  "settings.gateway.dialog.error.url": "Укажите HTTP- или HTTPS-адрес прокси без пути, параметров запроса и фрагмента.",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "Интеграция с WSL",
  "settings.desktop.wsl.description": "Запускать сервер KoteCode внутри WSL в Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык интерфейса KoteCode",
  ...
  "settings.general.row.appearance.description": "Настроить внешний вид KoteCode на этом устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выбрать системную, светлую или тёмную цветовую схему KoteCode",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настроить тему KoteCode.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске KoteCode",
  ...
  "settings.updates.toast.latest.description": "Установлена последняя версия KoteCode.",
