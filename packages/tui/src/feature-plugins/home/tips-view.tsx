...
const RU_TIPS: Tip[] = [
  ...
  "Используйте {highlight}kotecode run{/highlight} для неинтерактивного запуска",
...
const TIPS: Tip[] = [
  ...
  "Use {highlight}kotecode run{/highlight} for non-interactive scripting",
  "Use {highlight}kotecode --continue{/highlight} to resume the last session",
  "Use {highlight}kotecode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}kotecode serve{/highlight} for headless API access to KoteCode",
  "Use {highlight}kotecode run --attach{/highlight} to connect to a running server",
  "Run {highlight}kotecode upgrade{/highlight} to update to the latest version",
  "Run {highlight}kotecode auth list{/highlight} to see all configured providers",
  "Run {highlight}kotecode agent create{/highlight} for guided agent creation",
  ...
  "Run {highlight}kotecode debug config{/highlight} to troubleshoot configuration",
  ...
  "Install releases only from {highlight}github.com/koteyye/KoteCode{/highlight}",
