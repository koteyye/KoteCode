...
export function proxyForRequest(input: RequestInfo | URL, result: ResolveProxyResult): string | undefined {
...
export function proxyRequestInit(
  input: RequestInfo | URL,
  init: BunFetchRequestInit | undefined,
  result: ResolveProxyResult,
) {
...
export function proxyFetch(fetchFn: typeof globalThis.fetch, result: ResolveProxyResult): typeof globalThis.fetch {
  return Object.assign(
    (input: RequestInfo | URL, init?: BunFetchRequestInit) => fetchFn(input, proxyRequestInit(input, init, result)),
