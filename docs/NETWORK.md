...
| 6 | npm registry / Homebrew / Scoop / Chocolatey / `api.github.com/repos/.../releases` | Version/update checks | Periodically at launch | GET only; `User-Agent`; no auth | `OPENCODE_DISABLE_AUTOUPDATE=1` or `KOTECODE_DISABLE_UPDATE_CHECK=1` | **OpenCode** |
