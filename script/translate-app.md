...
- Preserve technical terms and artifacts exactly: KoteCode, OpenCode Go, OpenCode Zen, API names, identifiers, code, commands, flags, paths, URLs, versions, error messages, config keys, and placeholder tokens.
